...
export default function Hero() {
  ...
  return (
    <div className="bg-white">
      <div id="hero" className="relative pt-8 sm:pt-12 lg:pt-16 pb-12 overflow-hidden max-w-8xl mx-auto">
        <div className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden pt-4 sm:pt-8">
          {/* Content */}
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2 sm:py-4 text-center">
            <motion.div
            ...
            >
              ...
              <motion.p
                ...
                className="mt-3 text-sm sm:text-lg text-gray-600 max-w-xl mx-auto px-4 sm:px-0"
              >
              ...
              <motion.div
                ...
                className="mt-6 max-w-xl mx-auto px-4 sm:px-0"
              >
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="mt-1">
                    ...
                    <div className="mt-1 text-center">
                      <button
                        type="button"
                        className="group inline-flex items-center text-sm sm:text-base font-medium text-gray-700 hover:text-blue-600 transition-colors bg-gray-50 hover:bg-blue-50 px-4 py-2 rounded-full shadow-sm"
                      ...
                      <div id="imei-guide" className="hidden mt-2 bg-white rounded-lg p-4 shadow-md border border-gray-200 max-w-sm mx-auto">
                        <div className="grid grid-cols-3 gap-1">
                          {/* Pas 1 */}
                          <div className="flex flex-col items-center p-2 bg-blue-50 rounded-lg">
                            <div className="flex-shrink-0 w-6 h-6 bg-blue-500 rounded-full flex items-center justify-center mb-1">
                              <span className="text-xs font-bold text-white">1</span>
                            </div>
                            <p className="text-xs font-medium text-gray-900 text-center">Setări</p>
                          </div>
                          ...
                          <div className="flex flex-col items-center p-2 bg-blue-50 rounded-lg">
                            ...
                            <p className="text-xs font-medium text-gray-900 text-center">General</p>
                          </div>
                          ...
                          <div className="flex flex-col items-center p-2 bg-blue-50 rounded-lg">
                            ...
                            <p className="text-xs font-medium text-gray-900 text-center">Informati</p>
                          </div>
                        </div>
                      </div>
                    </div>
            ...
            <motion.div
              ...
              className="mt-8 relative max-w-[280px] sm:max-w-sm mx-auto pb-4 sm:pb-0"
            >
              <div className="relative">
                <Image
